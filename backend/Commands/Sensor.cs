...
namespace backend.Queries {
    ...
    public class GetAllSensorRequestHandler : IRequestHandler<GetAllSensorQuery, IEnumerable<Sensor>> {
        ...
        public async Task<IEnumerable<Sensor>> Handle(GetAllSensorQuery request, CancellationToken cancellationToken) => await _sensorService.GetAllSensors(request.Page, request.PageSize);
    }
    ...
    public class GetSensorByIdRequestHandler : IRequestHandler<GetSensorByIdQuery, Sensor> {
        ...
        public async Task<Sensor> Handle(GetSensorByIdQuery request, CancellationToken cancellationToken) => await _sensorService.GetSensorById(request.Id);
    }
...
namespace backend.Commands {
    ...
    public class CreateSensorRequestHandler : IRequestHandler<CreateSensorCommand, Sensor> {
        ...
        public async Task<Sensor> Handle(CreateSensorCommand request, CancellationToken cancellationToken) => await _sensorService.CreateSensor(request.Sensor);
    }
