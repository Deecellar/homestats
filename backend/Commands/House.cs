...
namespace backend.Queries {
    ...
    public class GetAllHouseSensorsHandler : IRequestHandler<GetAllHouseSensors, IEnumerable<HouseAggregator>> {
        ...
        public async Task<IEnumerable<HouseAggregator>> Handle(GetAllHouseSensors request, CancellationToken cancellationToken) {
            return await _houseService.GetAllHouseSensors(request.Page, request.PageSize, request.LimitSensors, request.OffsetSensors);
        }
    }
    ...
    public class GetHouseTemperaturesHandler : IRequestHandler<GetHouseTemperatures, IEnumerable<Temperature>> {
        ...
        public async Task<IEnumerable<Temperature>> Handle(GetHouseTemperatures request, CancellationToken cancellationToken) {
    ...
    public class GetHouseSunExposuresHandler : IRequestHandler<GetHouseSunExposures, IEnumerable<SunExposure>> {
        ...
        public async Task<IEnumerable<SunExposure>> Handle(GetHouseSunExposures request, CancellationToken cancellationToken) {
