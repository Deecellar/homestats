...
namespace backend.Data
{
    public class SensorRepository : GenericRepository<Sensor>, ISensorRepository
    {
        ...
        {
            var sensors = Collection.Find(Query.And(Query.EQ("SensorType", Enum.GetName(SensorType.Humidity)), Query.EQ("HouseId", id)), page, limit).ToList();
        ...
        {
            var sensors = Collection.Find(Query.And(Query.EQ("SensorType", Enum.GetName(SensorType.SunExposure)), Query.EQ("HouseId", id)), page, limit).ToList();
        ...
        {
            var sensors = Collection.Find(Query.And(Query.EQ("SensorType", Enum.GetName(SensorType.Temperature)), Query.EQ("HouseId", id)), page, limit).ToList();
